<template>
    <div>
        ...
        <div class="row headerClientes">
            <div>
                <h1>Clientes e  <br/>Parceiros</h1>
                <p>Um caminho de êxito conjunto</p>
            </div>
            ...
            <div>
                ...
                <div id="small-img" class="col-xs-12 col-sm-12 col-md-12 col-lg-12 center">
                    <ul style="list-style-type:none;"> 
                        ...
                        <li class="liClients"><img src="../assets/logo_commerzbank.png" class="img-responsive inline-block imgClients"></li>
                        <li class="liClients"><img src="../assets/logo_digicon.png" class="img-responsive inline-block imgClients"></li>
